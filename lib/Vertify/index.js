...
var _default = /*#__PURE__*/ (0, _react.memo)(function (_ref) {
  ...
  var _useState5 = (0, _react.useState)('sliderContainer'),
  ...
  var isMouseDownRef = (0, _react.useRef)(false);
  var trailRef = (0, _react.useRef)([]);
  var originXRef = (0, _react.useRef)(0);
  var originYRef = (0, _react.useRef)(0);
  var xRef = (0, _react.useRef)(0);
  var yRef = (0, _react.useRef)(0);
  var PI = Math.PI;
  ...
  var getRandomImgSrc = function getRandomImgSrc() {
    return (
      ...
      'https://picsum.photos/id/'
        .concat((0, _tool.getRandomNumberByRange)(0, 1084), '/')
        .concat(width, '/')
        .concat(height)
    );
  };
  ...
  var draw = function draw(img) {
    ...
    xRef.current = (0, _tool.getRandomNumberByRange)(L + 10, width - (L + 10));
    yRef.current = (0, _tool.getRandomNumberByRange)(
      10 + r * 2,
      height - (L + 10),
    );
  ...
  var verify = function verify() {
    ...
    var average = arr.reduce(_tool.sum) / arr.length;
    var deviations = arr.map(function (x) {
      return x - average;
    });
    var stddev = Math.sqrt(
      deviations.map(_tool.square).reduce(_tool.sum) / arr.length,
    );
